...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle = {
    filter: 'brightness(0.8) contrast(1.33) saturate(0.5)',
    opacity: 0.5,
          ...
          >
            ...
            <div
              style={{
                ...
                inset: '-50%',
                zIndex: 3,
                backgroundImage: 'url(/images/zenko-head-tile.svg)',
                backgroundRepeat: 'repeat',
                backgroundSize: '70px 79px',
                opacity: 0.12,
            ...
            {/* Shine layer - holographic foil effect */}
            <div style={shineStyle} />

            {/* Glare layer - pointer-following highlight */}
