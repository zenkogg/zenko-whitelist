...
import { ArrowUpTrayIcon, ArrowRightStartOnRectangleIcon, XMarkIcon } from '@heroicons/react/20/solid';
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-3">
            <div className="relative w-full aspect-square mb-3">
              <PixelCard
                ...
                gap={3}
                speed={20}
                className='!w-full !h-full !aspect-square rounded-2xl overflow-hidden !border-0'
              >
              ...
              {(isUploadingAvatar || isRemovingAvatar) && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm rounded-2xl z-20">
              ...
              {/* Avatar Controls - positioned at bottom of image */}
              <div className="absolute bottom-3 right-3 flex gap-2 z-30">
                ...
                {customAvatarUrl && (
                  <button
                    ...
                    className="cursor-pointer rounded-lg bg-black/60 p-2 text-red-400 transition-all hover:bg-black/80 hover:text-red-300 backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                {/* Upload Button */}
                <label
                  className="cursor-pointer rounded-lg bg-black/60 p-2 text-purple-300 transition-all hover:bg-black/80 hover:text-purple-50 backdrop-blur-sm"
            ...
            <div className="w-full flex items-center justify-between rounded-lg bg-white/5 px-3 py-2">
              {/* Left: User Info */}
              ...
              <button
                onClick={onLogout}
                className="text-purple-300 transition-colors hover:text-purple-50 opacity-70 hover:opacity-100"
                aria-label="Log out"
              >
